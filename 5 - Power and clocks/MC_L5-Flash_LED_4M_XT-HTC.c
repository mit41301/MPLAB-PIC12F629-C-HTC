/************************************************************************
*                                                                       *
*   Filename:      MC_L5-Flash_LED_4M_XT-HTC.c                          *
*   Date:          20/6/12                                              *
*   File Version:  1.2                                                  *
*                                                                       *
...
*                                                                       *
*   Demonstrates use of XT oscillator mode                              *
*   (using 4 MHz crystal or resonator)                                  *
*                                                                       *
...
// power-up timer enabled, XT oscillator (4 MHz)
__CONFIG(MCLRE_ON & CP_OFF & CPD_OFF & BOREN_OFF & WDTE_OFF & 
         PWRTE_OFF & FOSC_XT);

// Pin assignments
#define sF_LED  sGPIO.GP1           // flashing LED (shadow)
